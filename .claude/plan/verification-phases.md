...
| 담당자 | Phase | 역할 성격 |
|--------|-------|---------|
| **A** | Phase 2 → Phase 4 | Indexing 인프라 설계 + 구축 품질 검증 |
| **B** | Phase 3 → Phase 5 → Phase 6 | Search/Coverage 인프라 + 검색 전략 + 커버리지 검증 |
| **C** | Phase 1 → Phase 7 | KG 스키마 설계 + 충돌 해소 전략 |
